...
public class ClearProductsDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.dialog_clear_products_text);
        builder.setPositiveButton(R.string.dialog_clear_products_ok, this);
