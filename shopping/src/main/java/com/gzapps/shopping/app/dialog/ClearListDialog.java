...
public class ClearListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.dialog_clear_list_text);
        builder.setPositiveButton(R.string.dialog_clear_list_ok, this);
